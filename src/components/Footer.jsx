  ...
  return (
    <footer className="wood-texture-dark" id="contact" style={{ paddingTop: 40, paddingBottom: 20, color: 'var(--sand)' }}>
      <div className="container" style={{
        ...
        {/* العمود الثاني */}
        <div style={{ textAlign: 'center' }}>
          <h4 style={{ color: 'var(--gold-bright)', fontSize: 'clamp(0.75rem, 0.9vw, 1rem)', marginBottom: 8 }}>روابط سريعة</h4>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 4, alignItems: 'center' }}>
            <a href="#about" style={{ color: 'rgba(245,237,224,0.6)', fontSize: 'clamp(0.65rem, 0.8vw, 0.9rem)', transition: 'all 0.3s ease' }}>من نحن</a>
            <a href="#sections" style={{ color: 'rgba(245,237,224,0.6)', fontSize: 'clamp(0.65rem, 0.8vw, 0.9rem)', transition: 'all 0.3s ease' }}>الأقسام</a>
          </div>
        </div>
        
        {/* العمود الثالث */}
        <div style={{ textAlign: 'center' }}>
          <h4 style={{ color: 'var(--gold-bright)', fontSize: 'clamp(0.75rem, 0.9vw, 1rem)', marginBottom: 8 }}>تواصل معنا</h4>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 4, alignItems: 'center' }}>
            <a 
      ...
      <div style={{ borderTop: '1px solid rgba(245,237,224,0.06)', marginTop: 20, paddingTop: 12 }}>
        <p style={{ textAlign: 'center', color: 'rgba(245,237,224,0.3)', fontSize: 'clamp(0.55rem, 0.7vw, 0.8rem)' }}>
